          ...
          <CardContent className="space-y-3">
            {TODAY_SCHEDULE.map((cls, i) => (
              <div key={i} className="flex items-center gap-4 p-3 rounded-xl border border-border hover:bg-accent/50 transition-colors group">
                ...
                <Button size="sm" className="hidden group-hover:flex">Start Class</Button>
              </div>
            ))}
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <div className="flex items-center justify-between">
              ...
              <Button variant="ghost" size="sm" onClick={() => navigate('/teacher/assignments')}>View all <ArrowRight className="w-3.5 h-3.5" /></Button>
            </div>
          </CardHeader>
          <CardContent className="p-0">
            <Table>
